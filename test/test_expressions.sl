...
fn test_nested_evaluation0() -> void {
...

    {
        ...
        std::println(std::format!("obj.i = {} / y = {}", obj.i, y));
...
fn test_nested_evaluation1() -> void {
...

    {
        ...
        std::println(std::format!("i = {} / obj.arr=[{}, {}, {}] / obj.arr.length = {},", i, obj.arr[0], obj.arr[1], obj.arr[2], obj.arr.length));
...
fn test_nested_evaluation2() -> void {
...

    {
        ...
        std::println(std::format!("i = {} / obj2.s.arr=[{}, {}, {}] / obj2.s.arr.length = {},", i, obj2.s.arr[0], obj2.s.arr[1], obj2.s.arr[2], obj2.s.arr.length));
...
fn test_nested_evaluation3() -> void {
...

    {
        ...
        std::println(std::format!("i = {} / y = {} / a = [{}, {}, {}]", i, y, a[0], a[1], a[2]));
...
fn test_modify_returned_array() -> void {
    ...
    std::println(std::format!("{} {} {}", a[0], a[1], a[2]));
    ...
    std::println(std::format!("{} {} {}", b[0], b[1], b[2]));
