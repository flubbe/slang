...
void array_copy(si::context& ctx, si::operand_stack& stack)
{
    ...
    {
        auto* from_array = static_cast<si::fixed_vector<std::int32_t>*>(from);
        auto* to_array = static_cast<si::fixed_vector<std::int32_t>*>(to);
    ...
    {
        auto* from_array = static_cast<si::fixed_vector<void*>*>(from);
        auto* to_array = static_cast<si::fixed_vector<void*>*>(to);
