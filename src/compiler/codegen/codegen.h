...
class constant_i64 : public rvalue
{
    /** The integer. */
    std::int64_t i;
...
class constant_f64 : public rvalue
{
...
class constant_str : public rvalue
{
    /** The string id. */
