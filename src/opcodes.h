...
enum class opcode : opcode_base
{
    ...
    iloada,  /** Load element from i32 array onto stack. */
    floada,  /** Load element from f32 array onto stack. */
    sloada,  /** Load element from str array onto stack. */
    istorea, /** Store from stack into i32 array. */
    fstorea, /** Store from stack into f32 array. */
    sstorea, /** Store from stack into str array. */
